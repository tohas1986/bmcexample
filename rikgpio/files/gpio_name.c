...
static char *gpio_rikor[32] = {FM_SLPS4, FM_SLPS3, FM_MEM_THERM_EVENT, FM_PCH_BMC_THERMTRIP, FM_CPU_CATERR, FM_CPU_ERR2, IRQ_SERIAL, FM_BMC_MIC_MUX_RST, FM_BMC_PCH_SMI_LPC, SPEAKER_BMC, FP_ID_LED, 
  ...
  FM_INTRUDER_HDR, FM_BMC_PCH_SCI_LPC, FP_LED_STATUS_GREEN, FM_PS_PWROK, FM_BMC_FLASH_WP, FM_BIOS_POST_CMPL, IRQ_SML0_ALERT_N, FM_SMI_ACTIVE, FM_FORCE_BMC_UPDATE, FM_CPU1_DISABLE};

static short gpio_dir[32] = {FM_SLPS4_DIR, FM_SLPS3_DIR, FM_MEM_THERM_EVENT_DIR, FM_PCH_BMC_THERMTRIP_DIR, FM_CPU_CATERR_DIR, FM_CPU_ERR2_DIR, IRQ_SERIAL_DIR, FM_BMC_MIC_MUX_RST_DIR, 
  ...
  FM_BMC_FLASH_WP_DIR, FM_BIOS_POST_CMPL_DIR, IRQ_SML0_ALERT_N_DIR, FM_SMI_ACTIVE_DIR, FM_FORCE_BMC_UPDATE_DIR, FM_CPU1_DISABLE_DIR};

int gpio_rikor_num[32] = {};
/********************************************************************************************/
