...
devmem_set_bit $(scu_addr 88) 4
devmem_set_bit $(scu_addr 88) 5
...
echo 7 > $PWM_DIR/tacho4_source
echo 1 > $PWM_DIR/tacho1_source
echo 6 > $PWM_DIR/tacho5_source
echo 3 > $PWM_DIR/tacho2_source
echo 5 > $PWM_DIR/tacho6_source
echo 2 > $PWM_DIR/tacho3_source
echo 4 > $PWM_DIR/tacho7_source
t=0
while [ $t -le 7 ]; do
